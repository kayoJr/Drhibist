							...
							<form action="../../backend/upd_pat.php" method="POST">
                                ...
                                <div class="form-elements">
                                    <div>
                                        ...
                                        <input type="text" name="name" id="name" value="<?php echo $pat_name; ?>" required>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="sex" id="sex" value="<?php echo $sex; ?>" required>
                                    </div>
                                    <div>
                                        <label for="phone">Phone</label>
                                        <input type="number" name="phone" id="phone" value="<?php echo $pat_phone; ?>" >
                                    </div>
