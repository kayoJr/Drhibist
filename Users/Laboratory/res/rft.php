            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="titel">
                        <h2 class="center">RENAL FUNCTION TEST RESULT</h2>
                        </div>
                        <?php
                        $id = $_GET['id'];
                        ?>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="creatinine" id="creatinine">
                                            </div>
                                           
                                            </div>
                                        <input type="submit" name="submitrft" value="SEND" class="btn bnt-primary">
