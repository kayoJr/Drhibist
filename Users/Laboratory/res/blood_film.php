                             ...
                             <div class="lab-res">
                                <form action="../../../backend/lab_res.php" method="POST">
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                <label for="Blood_film">Blood film</label>
                                                <input type="text" name="Blood_film" id="Blood_film" step=".01">
                                            </div>
                                            </div>
                                        <input type="submit" name="submitbf" value="SEND" class="btn bnt-primary">
