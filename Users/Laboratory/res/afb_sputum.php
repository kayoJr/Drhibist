                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                ...
                                                <input type="text" name="spot" id="spot" step=".01" value="0">
                                            </div>
                                            <div>
                                                <label for="morning">Morning</label>
                                                <input type="text" name="morning" id="morning" step=".01" value="0">
                                            </div>
                                          <input type="hidden" name="pat_id" value="<?php echo $id; ?>">
                                            </div>
                                        <input type="submit" name="submitafb" value="SEND" class="btn bnt-primary">
