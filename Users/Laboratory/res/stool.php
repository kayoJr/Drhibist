                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                ...
                                                <input type="text" name="Appearance" id="Appearance" step=".01">
                                            </div>
                                            <div>
                                                <label for="Consistency">Consistency</label>
                                                <input type="text" name="Consistency" id="Consistency" step=".01">
                                            </div>
                                            <div>
                                                <label for="Ova_Parasite">Ova/Parasite</label>
                                                <input type="text" name="Ova_Parasite" id="Ova_Parasite" step=".01">
                                            </div>
                                        </div>
                                        <div class="column">
                                            <div>
                                                <label for="PUS_cells">PUS cells</label>
                                                <input type="text" name="PUS_cells" id="PUS_cells" step=".01">
                                            </div>
                                            <div>
                                                <label for="Mucus">Mucus</label>
                                                <input type="text" name="Mucus" id="Mucus" step=".01">
                                            </div>
                                            </div>
                                        
                                        <input type="submit" name="submitst" value="SEND" class="btn bnt-primary">
