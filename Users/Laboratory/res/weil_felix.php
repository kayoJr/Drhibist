            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="titel">
                        <h2 class="center">WEIL_FELIX RESULT</h2>
                        </div>
                        <?php
                        $id = $_GET['id'];
                        ?>
                             ...
                             <div class="lab-res">
                                <form action="../../../backend/lab_res.php" method="POST">
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                <label for="weil">WEIL_FELIX</label>
                                                <input type="text" name="weil" id="weil">
                                            </div>
                                           
                                            </div>
                                        <input type="submit" name="submitweilf" value="SEND" class="btn bnt-primary">
