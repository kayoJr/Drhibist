            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="titel">
                        <h2 class="center">WIDAL .H RESULT</h2>
                        </div>
                        <?php
                        $id = $_GET['id'];
                        ?>
                             ...
                             <div class="lab-res">
                                <form action="../../../backend/lab_res.php" method="POST">
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                <label for="widalh">Widal H</label>
                                                <input type="text" name="widalh" id="widalh">
                                            </div>
                                           
                                            </div>
                                        <input type="submit" name="submitwidalh" value="SEND" class="btn bnt-primary">
