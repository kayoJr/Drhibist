                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                ...
                                                <input type="text" name="sgot" id="sgot">
                                            </div>
                                            <div>
                                                <label for="sgpt">SGPT</label>
                                                <input type="text" name="sgpt" id="sgpt">
                                            </div>
                                            <div>
                                                <label for="alk_phos">Alk_Phosphatase</label>
                                                <input type="text" name="alk_phos" id="alk_phos">
                                            </div>
                                           
                                            </div>
                                        <input type="submit" name="submitlet" value="SEND" class="btn bnt-primary">
