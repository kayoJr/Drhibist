            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="titel">
                        <h2>SERUM ELECTROLYTE RESULT</h2>
                        </div>
                        <?php
                        $id = $_GET['id'];
                        ?>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                ...
                                                <input type="text" name="Sodium" id="Sodium" step=".01">
                                            </div>
                                            <div>
                                                <label for="Potassium">Potassium</label>
                                                <input type="text" name="Potassium" id="Potassium" step=".01">
                                            </div>
                                            <div>
                                                <label for="Calsium">Calsium</label>
                                                <input type="text" name="Calsium" id="Calsium" step=".01">
                                            </div>
                                            <div>
                                                <label for="Others">Others</label>
                                                <input type="text" name="Others" id="Others" step=".01">
                                            </div>
                                            
                                        </div>
                                        <input type="submit" name="submitse" value="SEND" class="btn bnt-primary">
