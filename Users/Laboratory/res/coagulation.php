                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                ...
                                                <input type="text" name="PT" id="PT" step=".01">
                                            </div>
                                            <div>
                                                <label for="PTT">PTT</label>
                                                <input type="text" name="PTT" id="PTT" step=".01">
                                            </div>
                                            <div>
                                                <label for="INR">INR</label>
                                                <input type="text" name="INR" id="INR" step=".01">
                                            </div>
                                            
                                        </div>
                                        <input type="submit" name="submitco" value="SEND" class="btn bnt-primary">
