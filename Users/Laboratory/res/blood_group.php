            ...
            <div id="content">
                ...
                <div class="midde_cont">
                    <div class="container-fluid">
                        ...
                        <div class="titel">
                        <h2 class="center">BLOOD GROUP</h2>
                        </div>
                        <?php
                        $id = $_GET['id'];
                        ?>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="column">
                                            <div>
                                                ...
                                                <!-- <input type="text" name="Blood_group" id="Blood_group" step=".01"> -->
                                                <select name="bg" id="Blood_group">
                                        ...
                                        <input type="submit" name="submitbg" value="SEND" class="btn bnt-primary">
