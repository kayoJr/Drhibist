				...
				<div class="midde_cont">
					<div class="container-fluid">
						...
						if (isset($_GET['searching'])) {
							@$med_name = $_GET['med'];
							$search_sql = "SELECT * FROM `medicine` WHERE `name` = '$med_name'";
									...
									echo "	
												<tbody>
													<tr>
														...
														<td data-label='Org price'>$org_price</td>
														<td data-label='Sell Price'>$sell_price</td>
							...
							//if ($rs) {
								//while ($result = $rs->fetch_assoc()) {
									...
									$sql = 'SELECT * FROM `medicine` ORDER BY `reg_date` DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
