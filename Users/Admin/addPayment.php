				...
				<div id="content">
					...
					<div class="midde_cont">
						...
						<p class="succ">
							...
							<form action="../../backend/addPayment.php" method="POST">
                                <h3>Add Payment</h3>
                                <div class="form-elements">
                                    ...
                                    <div>
                                        <input type="submit" name="submit" value="Add Payment" class="btn btn-primary mt-4">
                                    </div>
                                </div>
								...
								if($res){
									...
									<tr>
										...
										<td data-label='Action' class='delete'>
                                            <a href='../../backend/deletePayment.php?id=$id'>Delete</a>
                                        </td>
