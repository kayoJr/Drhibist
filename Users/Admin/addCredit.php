				...
				<div id="content">
					...
					<div class="midde_cont">
						...
						<p class="succ">
							...
							<form action="../../backend/addPartner.php" method="POST">
                                <h3>Add Partner</h3>
                                <div class="form-elements">
                                    ...
                                    <div>
                                        <input type="submit" name="submit" value="Add Partner" class="btn btn-primary mt-4">
                                    </div>
                                </div>
                            ...
                            <?php
								$phone = $_SESSION['user'];
								$sql = "SELECT * FROM `creditproviders`";
								$res = $conn->query($sql);
								echo "
								<table class='table'>
								<thead>
								...
								if($res){
									...
									<tr>
										...
										<td data-label='Action' class='delete'>
                                            <a href='../../backend/deletePartner.php?id=$id'>Delete</a>
                                        </td>
